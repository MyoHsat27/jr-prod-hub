...
const socialLinks = [
  {
    name: "YouTube",
    url: "https://www.youtube.com/@jrprxd1",
    glowColor: "rgba(255, 0, 0, 0.15)",
    borderHover:
      "hover:border-red-500/40 hover:shadow-[0_0_20px_rgba(255,0,0,0.1)]",
    icon: (
  ...
  {
    name: "SoundCloud",
    url: "https://soundcloud.com/jrpxrd1111111",
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/jrprxd_",
        ...
        >
          {socialLinks.map((link) => (
            <motion.a
              ...
              whileHover={{ x: 4 }}
              className={`group flex items-center gap-4 border border-white/6 bg-white/2 p-5 text-neutral-400 transition-all duration-300 ${link.borderHover}`}
              style={{
                clipPath:
